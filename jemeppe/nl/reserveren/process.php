...
if(isset($error) == 1) {
    header('location: http://broowse.com/jemeppe/nl/reserveren?error=1');
}
...
if($aborted > 0){
    header("location: http://www.broowse.com/jemeppe/nl/reserveren?error=2&room=$room&arrival=$arrivalDate&departure=$departureDate&adults=$adults&children=$children");
}
if($aborted === 0) {
    $_SESSION['room'] = $room;
