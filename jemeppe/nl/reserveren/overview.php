...
if(isset($_POST['success'])){
    if($_POST['success'] == 1){
        ...
        if($booking->insertBooking($mysqli)) {
            header('location: http://www.broowse.com/jemeppe/nl/reserveren/success');
        }
    }
    if($_POST['success'] == 0){
        unset($_SESSION['room']);
        ...
        header('location: http://www.broowse.com/jemeppe/nl/kamers/');
    }
}
    ...
    <body>
        ...
        <div class='container'>
            ...
            <div class='btn-toolbar'>
                <form action="nl/reserveren/overview" method="POST">
                    <button name="success" value="0" type="submit" class='btn btn-danger pull-left'>Annuleren</button>
                    <button name="success" value="1" type="submit" class='btn btn-info pull-right'>Doorgaan met betalen</button>
                </form>
            </div>
        </div>
