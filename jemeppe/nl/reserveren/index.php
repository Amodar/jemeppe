...
if(!empty($error) == 1) {
    header('location: http://broowse.com/jemeppe/nl/kamers?error=1');
}
...
<html>
    ...
    <body>
        ...
        <div class="container centered">
            ...
            <div class="col-md-12">
                <form action="nl/reserveren/process" method="post" role="form">
                    <div class="row">
                            ...
                            <select class="form-control" name="room">
                                <?php
                                    foreach ($o_roomId as $o_roomId) {
                                        ...
                                        echo "(kamer naam: " . $room1->getRoom_name() . ") ( prijs per nacht per persoon: &euro;" . $room1->getPrice() . ") ( ruimte: " . $room1->getCapacity() . " + 1 kind)";
                                        echo "</option>";
                                    }
                                ?>
                            </select>
                        ...
                        <div class="form-group col-md-12">
                            <input type="submit" value="BEVESTIGEN & DOORGAAN" class="form-control btn btn-danger">
                        </div>
                    </div>
                </form>
            </div>
