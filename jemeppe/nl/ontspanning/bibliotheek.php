        ...
        <div class='container centered'>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <img style="height: 300px;" src="../../jemeppe/media/image/leisure/library/library1.jpg">
                    <img style="height: 300px;" src="../../jemeppe/media/image/leisure/library/library2.jpg">
                </div>
            </div>
        </div>
        <div class="container">
