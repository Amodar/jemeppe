...
<html>
        ...
        <script defer="defer">
            ...
            function validateAvailable(){
                ...
                if(!arrivalDate || !departureDate) {
                    alert("Vul in uw gewenste aankomstdatum en vertrekdatum in en klik op 'check beschikbaarheid'.");
                    return false;
                } else {
                    return true;
                }
    ...
    <body>
        ...
        <div class="container">
            <form action="nl/kamers/" method="post" role="form" id="formAvailable">
                <div class="row">
                    <div class="form-group col-md-2">
                        <label for="rooms">Kies kamer</label> 
                    ...
                    <div class="input-daterange" id="datepicker">
                        <div class="form-group col-sm-3"> 
                            <label for="arrival">Aankomst datum</label>       <input style="cursor:pointer" readonly="true" type="text" value="<?= $arrivalDate ?>" class="input-sm-2 form-control" name="arrival"  id="arrival">
                        </div>
                        <div class="form-group col-sm-3">
                            <label for="departure">Vertrek datum</label>   <input style="cursor:pointer" readonly="true" type="text" value="<?= $departureDate ?>" class="input-sm-2 form-control" name="departure"  id="departure" >
                        </div>
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="adults">Volwassenen</label>              <input type="number" min="1" max="5" step="1" value="<?= $adults ?>" id="adults" name="adults" class="form-control">
                        
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="children">Kinderen(0-3)</label>        <input type="number" min="0" max="5" step="1" value="<?= $children ?>" id="children" name="children" class="form-control">
                    </div>
                    <div class="form-group col-md-12">
                        <input type="submit" value="Check beschikbaarheid" class="form-control btn btn-danger" id="checkAvailable">
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <form role="form" action="nl/reserveren/" method="POST" id="submitBooking">
                                <div class="btn-toolbar">
                                    ...
                                    <input type="submit" onclick="return validateAvailable();" value="Reserveer deze kamer" class="btn btn-primary pull-right" />
                                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target='#<?= $trim_o_roomId ?>'>Meer info</button>
                                </div>
                            </form>
