    ...
    <body>
        ...
        <?php
            if (login_check($mysqli) == true) {
                ...
                if(isset($_SESSION['bookMode']) == 1){
                    header('location: http://www.broowse.com/jemeppe/nl/reserveren/overview');                   
                }
        ...
        <div class="container">
            <div class="pull-right">
                ...
                <form action="nl/account" method="get" role="form">
        ...
        <div class="container">
            <div class="centered">
                <a href='nl/account/recensie'>
                    <div class="account-menu-box col-md-3">
                        <div class='icon'><i class="fa fa-newspaper-o fa-5x"></i></div>
                        <hr>
                        <div class="account-box-text"><p class="lead">Schrijf een recensie</p></div>
                    </div>
                </a>
                <a>
                    <div class="account-menu-box col-md-3">
                        ...
                        <hr>
                        <div class="account-box-text"><p class="lead">Betalingen</p></div>
                    </div>
                </a>
                <a href='nl/account/factuur'>
                    <div class="account-menu-box col-md-3">
                        <div class='icon'><i class="fa fa-file-text-o fa-5x"></i></div>
                        <hr>
                        <div class="account-box-text"><p class="lead">Factuur</p></div>
                    </div>
                </a>
                <a>
                    <div class="account-menu-box col-md-3">
                        ...
                        <hr>
                        <div class="account-box-text"><p class="lead">Verander account informatie</p></div>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="container">
            ...
            ?>
            <form action="nl/account/process" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label>Email</label> <input type="email" name="email" id="email" class="form-control" placeholder="Enter your email adres">
                        <label>Wachtwoord</label> <input type="password" name="password" id="password" class="form-control" placeholder="Enter your password">
                        <br>
                        <div class='col-md-12 centered'>
                            <a href="nl/registreren"><input type="button" value="Maak nieuwe account aan"  class="btn btn-info"></a>  
                            <input type="submit" value="Log in" class="btn btn-danger pull-right" class="form-control ">
                        </div>
                    </div>
                </div>
            </form>
            
            Wachtwoord vergeten? <a>klik hier</a><br>
        </div>
        <?php } ?>
    </body>
</html>