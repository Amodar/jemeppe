        ...
        <div class='container'>
            <div class='container' style='border: 1px solid black; margin: 0; padding: 0;' >    
                ...
                <div class='container' style='border-top: 1px solid black; border-bottom: 1px solid black; width: auto;'>
                    ...
                    <div class='col-md-4 centered'>
                        <label>BEDRIJF</label><p>Castle Jemeppe</p>
                        <label>LID NO.</label><p><?= $id_user ?></p>
                ...
                <div class='container'>
                    <table class='table'>
                        ...
                        <tr>
                            <td></td>
                            <td style='text-align: right;'>ADMINISTRATIE KOSTEN</td>
                            <td><i class="fa fa-eur"></i><?= $administrationCost ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style='text-align: right;'>EXTRA KOSTEN</td>
                            <td><i class="fa fa-eur"></i><?= $additionalCost ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style='text-align: right;'>BELASTING</td>
                            <td><?= $tax ?>%</td>
                        </tr>
