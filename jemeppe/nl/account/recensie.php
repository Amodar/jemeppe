    ...
    <body>
        ...
        if (login_check($mysqli) == true) {
            ...
            if(isset($_POST['submit']) == "update") {
                ...
                header("location: http://www.broowse.com/jemeppe/nl/account/recensie?msg=1");
            }
        ...
        <br>
        <div class='container'>
            <?php echo isset($_GET['msg']) == 1 ? "<p class='mark centered'>Uw recensie is geplaatst, dank u.</p>" : null; ?>
            <form action='nl/account/recensie' method='POST'>
                <label>Uw cijfer</label>
                <select class='form-control' name='rating'>
                    <?php
                    echo $review_rating == null ? "<option selected>" : "</option>";
                    echo "Kies uw beoordeling";
                    echo "</option>";
                    for($i = 1; $i <= 5; $i++) {
