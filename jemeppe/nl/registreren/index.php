    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="en/registration/process" method="POST" role="form">
                ...
                <div class="form-group col-md-6">
                    <label for="password">Wachtwoord</label> <input type="password" id="password" name="password" class="form-control" placeholder="Enter your password" required>
                </div>
                
                <div class="form-group col-md-4">
                    <label for="firstname">Voornaam</label> <input type="text" id="firstname" name="firstname"  class="form-control" placeholder="Enter your first name" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="middlename">Toevoegsel</label> <input type="text" id="middlename" name="middlename"  class="form-control" placeholder="Enter your middle name">
                </div>
                <div class="form-group col-md-4">
                    <label for="lastname">Achternaam</label> <input type="text" id="lastname" name="lastname"  class="form-control" placeholder="Enter your last name" required>
                </div>
                <div class="form-group col-md-12">
                    <div class="checkbox">
                        <label>
                          <input type="radio" name="gender" value="male" required> <b>Man</b>
                        </label>
                        <label>
                          <input type="radio" name="gender" value="female" required> <b>Vrouw</b>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    <label for="houseNumber">Telefoon nummer</label> <input type="text" id="houseNumber" name="houseNumber"  class="form-control" placeholder="Enter your middle name">
                </div>
                <div class="form-group col-md-4">
                    <label for="mobileNumber">Mobiel nummer</label> <input type="text" id="mobileNumber" name="mobileNumber"  class="form-control" placeholder="Enter your middle name">
                </div>
                <div class="form-group col-md-4">
                    <label for="additionalNumber">Extra nummer</label> <input type="text" id="additionalNumber" name="additionalNumber"  class="form-control" placeholder="Enter your middle name">
                </div>
                ...
                <div class="form-group col-md-3">
                    <label for="city">Stad</label> <input type="text" id="city" name="city" class="form-control" placeholder="Enter your city" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="zipcode">Postcode</label> <input type="text" id="zipcode" name="zipcode"  class="form-control" placeholder="Enter your middle name" required>
                </div>
                ...
                <div class="form-group col-md-12 ">
                    <input type="submit" value="Account aanmaken" class="btn btn-danger pull-right" class="form-control">
                </div>
            </form>
        </div>
    </body>
