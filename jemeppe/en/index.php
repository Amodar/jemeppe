...
<html>
    ...
    <div class="container">
        <iframe id="youtubevid" width="100%" height="50%" src="//www.youtube.com/embed/iJtTJZlmt4E?hd=1&rel=0&autohide=1&showinfo=0" frameborder="0" allowfullscreen></iframe>
    </div>
        ...
        <div id='container' class='container-fluid'>
            ...
            ?>
                <div class='col-md-4' style='background-color: whitesmoke;'>
                    ...
                    <blockquote>
                        <?= (substr($review_content, 0, 265)) . "<a href='/jemeppe/en/reviews'>...</a>"; ?>
                    </blockquote>
